...
def create_or_update_release(user, pwd, secret, repo_slug, changelog_file, doc_url, data_file, tag):
    ...
    try:
        ...
        # release.url          # 'https://api.github.com/repos/smarie/python-genbadge/releases/13928525'
        # release.html_url     # 'https://github.com/smarie/python-genbadge/releases/tag/0.5.0'
        # release.tarball_url  # 'https://api.github.com/repos/smarie/python-genbadge/tarball/0.5.0'
        # release.zipball_url  # 'https://api.github.com/repos/smarie/python-genbadge/zipball/0.5.0'
        # release.upload_url   # 'https://uploads.github.com/repos/smarie/python-genbadge/releases/13928525/assets{?name,label}'
