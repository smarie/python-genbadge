...
from nox_utils import (PY38, PY39, PY310, PY311, PY312, PY313, PY314, install_reqs, rm_folder, rm_file,
                       DONT_INSTALL)  # noqa
...
ENVS = {
    # PY314: {"coverage": False, "pkg_specs": {"pip": ">19"}}, error : pillow does not support it yet
...
def tests(session, coverage, pkg_specs):
    ...
    if not coverage:
        ...
        install_reqs(session, phase="coverage",
                             phase_reqs=["coverage", "pytest-html", "requests"],
